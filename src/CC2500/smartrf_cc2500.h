...
#define SMARTRF_SETTING_FSCTRL0       0x00 /* Data whitening off? */
#define SMARTRF_SETTING_FREQ2         0x5D // 0x5D // Carrier Frequency is 2.433GHz 
#define SMARTRF_SETTING_FREQ1         0x94 // 0x93 // Carrier Frequency is 2,433,072kHz
#define SMARTRF_SETTING_FREQ0         0x66 // 0xB1 
